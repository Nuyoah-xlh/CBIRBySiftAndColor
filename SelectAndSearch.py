...
class SelectAndSearch(object):
    ...
    def create(self):
        ...
        #  基于SIFT特征检索
        enter_sift = tk.Button(self.app, text="基于SIFT特征检索", font=("宋体", 20), command=lambda: enter(0))
        enter_sift.place(relx=0.25, rely=0.45, relwidth=0.2, relheight=0.1)

        #  基于颜色特征检索
        enter_color = tk.Button(self.app, text="基于颜色特征检索", font=("宋体", 20), command=lambda: enter(1))
        enter_color.place(relx=0.5, rely=0.45, relwidth=0.2, relheight=0.1)
        ...
        def enter(option):
            ...
            word2 = tk.Label(result, text='检索结果：', font=("宋体", 25), image=photo, compound=tk.CENTER)
        ...
        def back(result):
            ...
            title.place(relx=0.35, rely=0.2, relwidth=0.3, relheight=0.1)
